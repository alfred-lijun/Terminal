...
static Utils::Icon NEW_TERMINAL_ICON(
    {{":/terminal/images/terminal.png", Utils::Theme::IconsBaseColor},
     {":/terminal/images/iconoverlay_add_small.png", Utils::Theme::IconsRunToolBarColor}});

static Utils::Icon CLOSE_TERMINAL_ICON(
    {{":/terminal/images/terminal.png", Utils::Theme::IconsBaseColor},
     {":/terminal/images/iconoverlay_close_small.png", Utils::Theme::IconsStopToolBarColor}});
